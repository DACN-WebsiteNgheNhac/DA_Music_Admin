...
namespace CustomControls.Utils
{
    public static class ColorConst
    {
        ...
        public static Color foregroundColor_40 = Color.FromArgb(60, 240, 240, 240);
        ...
        public static void Register(Window window)
        {
            ...
            foregroundColor_40 = (window.FindResource("ForegroundColor_40") as SolidColorBrush).Color;
